...
cd ${TEMP_DIR}
#download http://downloads.mongodb.org/linux/${MONGO_TARBALL_NAME} ${TEMP_DIR}/${MONGO_TARBALL_NAME}
ctx download-resource resources/mongo/${MONGO_TARBALL_NAME} ${TEMP_DIR}/${MONGO_TARBALL_NAME}
untar ${TEMP_DIR}/${MONGO_TARBALL_NAME} ${MONGO_BINARIES_PATH}
