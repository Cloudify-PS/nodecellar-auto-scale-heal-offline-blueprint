...
NODECELLAR_ARCHIVE_NAME=nodecellar.tar.gz
ctx download-resource resources/nodecellar/nodecellar.tar.gz ${NODECELLAR_ROOT_PATH}/${NODECELLAR_ARCHIVE_NAME}
tar xzfv ${NODECELLAR_ARCHIVE_NAME} 
